...
sensor_data0 = x0[:-500000, 3:]
odors_data0 = x0[:-500000, 1:3]
times0 = x0[:-500000, 0]
sensor_data1 = x1[:-500000, 3:]
odors_data1 = x1[:-500000, 1:3]
times1 = x1[:-500000, 0]
...
print([len(eth_Me['gas'][i]) for i in Me_plit_index])
...
for index_m in Me_plit_index:
    ...
    label_temp_m0 = eth_Me['label'][index_m][:index_ms]; times_temp_m0 = eth_Me['times'][index_m][:index_ms]
    label_temp_m1 = eth_Me['label'][index_m][index_ms:]; times_temp_m1 = eth_Me['times'][index_m][index_ms:]
