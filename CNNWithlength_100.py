...
start = time.time()
acc_test, loss_test, _ = CNN_process_reload(gas_test)
print('predict model cost %f sec'%((time.time()-start)/len(gas_test['label']))
test_result = {}
...
test_path='/home/wzh/PycharmProjects/data/multilabel/multilabel_Xavier/Cross_valid/BNModel/result/test_result_grd0.txt'
